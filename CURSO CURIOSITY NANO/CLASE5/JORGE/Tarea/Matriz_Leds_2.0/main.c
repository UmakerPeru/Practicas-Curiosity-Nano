...
void main(void) {
    ...
    while (1){
        /* 1ª Ciclo For -> Encendido y apagado de leds: Extremos -> Centro*/
        ...
        /* 2ª Ciclo For -> Encendido y apagado de leds (Retorno): Centro -> Extremos*/
        /* Para evitar repetitividad de los Leds, se encienden solo LEDS INTERMEDIOS
          RF1 <- RF2 || RF5 -> RF6 */  
        for(i=5;i<7;i++){ 
            encenderLed(i);
            encenderLed(7-i);
